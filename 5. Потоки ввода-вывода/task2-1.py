...
# Добавляем метки и заголовок: Чтобы ваш график выглядел информативно, добавляем подписи к осям и заголовок:
plt.xlabel('Дата')
plt.ylabel('Кол-во')
plt.title('Простой график')

plt.show()  # Агрумент block=True программа останавливается, пока график не будет закрыт пользователем.

fixed_df.plot(figsize=(17, 9))
plt.show()
