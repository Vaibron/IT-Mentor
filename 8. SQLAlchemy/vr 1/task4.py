...
session.add_all([
    ...
    Employee(LastName='Петров', FirstName='Петр', MiddleName='Петрович', Position='Продавец',
             Address='г. Санкт-Петербург, ул. Невского, д. 2', HomePhone='+7(911)123-45-67',
    ...
    Employee(LastName='Кузнецов', FirstName='Кузьма', MiddleName='Кузьмич', Position='Оператор',
             Address='г. Нижний Новгород, ул. Большая Покровская, д. 4', HomePhone='+7(929)123-45-67',
...
# Suppliers
session.add_all([
    Supplier(SupplierName='Компания А', SupplierRepresentative='Иванов Иван', ContactPhone='+7(900)123-45-67',
             Address='г. Москва, ул. Ленина, д. 1'),
    Supplier(SupplierName='Компания Б', SupplierRepresentative='Петров Петр', ContactPhone='+7(911)123-45-67',
             Address='г. Санкт-Петербург, ул. Невского, д. 2'),
    Supplier(SupplierName='Компания В', SupplierRepresentative='Сидоров Сидор', ContactPhone='+7(922)123-45-67',
             Address='г. Екатеринбург, ул. 8 Марта, д. 3'),
    Supplier(SupplierName='Компания Г', SupplierRepresentative='Кузнецов Кузьма', ContactPhone='+7(929)123-45-67',
             Address='г. Нижний Новгород, ул. Большая Покровская, д. 4'),
    Supplier(SupplierName='Компания Д', SupplierRepresentative='Смирнов Семён', ContactPhone='+7(914)123-45-67',
...
# Products
session.add_all([
    Product(DeliveryID=1, ProductName='Товар 1', TechnicalSpecifications='Технические характеристики 1',
            Description='Описание товара 1', Image='image1.jpg', PurchasePrice=100.00, SalePrice=150.00),
    Product(DeliveryID=2, ProductName='Товар 2', TechnicalSpecifications='Технические характеристики 2',
            Description='Описание товара 2', Image='image2.jpg', PurchasePrice=200.00, SalePrice=250.00),
    Product(DeliveryID=3, ProductName='Товар 3', TechnicalSpecifications='Технические характеристики 3',
            Description='Описание товара 3', Image='image3.jpg', PurchasePrice=300.00, SalePrice=350.00),
    Product(DeliveryID=4, ProductName='Товар 4', TechnicalSpecifications='Технические характеристики 4',
            Description='Описание товара 4', Image='image4.jpg', PurchasePrice=400.00, SalePrice=450.00),
    Product(DeliveryID=5, ProductName='Товар 5', TechnicalSpecifications='Технические характеристики 5',
